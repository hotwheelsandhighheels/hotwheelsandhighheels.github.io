...
(function() {
  ...
  container.addEventListener('click', function(e) {
    ...
    'node-millennial-epoch': {
      ...
      type: 'Center',
      description: 'A series of overlapping transformations in technology, politics, economics, and culture that changed the conditions of life for millennials and everyone after.',
      link: '/Trunk/epoch/'
    },
    'node-double-perspective': {
      title: 'Double Perspective',
      type: 'Framework',
      description: 'A framework for memory. Experience Self + Narrator Self = Double Perspective. Built from Gornick and Lopate.',
      link: '/Trunk/dp/'
    },
    ...
    'node-archive-fever': { title: 'Archive Fever', type: 'Concept', description: 'Derrida\'s concept. The compulsive need to record, preserve, return to the origin.', link: null },
    'node-the-drivers': { title: 'The Drivers', type: 'Collection', description: 'Millennial experience is place, loss, intimacy, web, identity, expression, future, care, witness, surveillance, emergence, threshold.', link: '/Trunk/drivers/' },
    ...
    'node-driver-loss': { title: 'Loss', type: 'Theme', description: 'Demolished places, lost records, disappearing communities, vanished internet traces.', link: '/Trunk/drivers/#loss' },
    'node-driver-intimacy': { title: 'Intimacy', type: 'Theme', description: 'Family, friendship, vulnerability, private memory.', link: '/Trunk/drivers/#intimacy' },
    'node-driver-web': { title: 'Web', type: 'Theme', description: 'Platforms, searchability, digital mediation, algorithmic memory.', link: '/Trunk/drivers/#web' },
    'node-driver-identity': { title: 'Identity', type: 'Theme', description: 'Culture, race, gender, class, self-construction.', link: '/Trunk/drivers/#identity' },
    'node-driver-expression': { title: 'Expression', type: 'Theme', description: 'Poetry, art, memes, creative meaning-making.', link: '/Trunk/drivers/#expression' },
    'node-driver-future': { title: 'Future', type: 'Theme', description: 'Hope, preservation, community futures, technological futures.', link: '/Trunk/drivers/#future' },
    'node-driver-care': { title: 'Care', type: 'Theme', description: 'Mutual support, community, love, responsibility.', link: '/Trunk/drivers/#care' },
    'node-driver-witness': { title: 'Witness', type: 'Theme', description: 'Observation, documentation, memorialization, testimony.', link: '/Trunk/drivers/#witness' },
    'node-driver-surveillance': { title: 'Surveillance', type: 'Theme', description: 'Platforms, data collection, visibility, tech power.', link: '/Trunk/drivers/#surveillance' },
    ...
    'node-driver-threshold': { title: 'Threshold', type: 'Theme', description: 'Migration, generational transition, analog to digital, past to future.', link: '/Trunk/drivers/#threshold' },
    'node-memory-technologies': { title: 'Memory Technologies', type: 'Branch', description: 'The tools that shape how we remember. Each technology codetermines our memory.', link: null },
    ...
    'node-forums': { title: 'Forums', type: 'Technology', description: 'Bulletin boards, Reddit, Discord.', link: null },
    ...
    'node-tiktok': { title: 'TikTok', type: 'Platform', description: 'Algorithmic discovery. The first platform the U.S. government tried to ban.', link: null },
    'node-smartphones': { title: 'Smartphones', type: 'Technology', description: 'A computer, camera, microphone, GPS tracker in your hand. Everyday life is documented experience.', link: null },
    ...
    'node-berners-lee-web': { title: 'Berners-Lee\'s Web', type: 'Branch', description: 'The vision: a universally linked information system. Hypertext, universal access, free to everyone.', link: null },
    'node-hypertext': { title: 'Hypertext', type: 'Concept', description: 'Human-readable information linked in an unconstrained way.', link: null },
    'node-hypermedia': { title: 'Hypermedia', type: 'Concept', description: 'The expansion of hypertext to graphics, sound, video.', link: null },
    'node-universal-access': { title: 'Universal Access', type: 'Concept', description: 'Everyone should be able to read the web.', link: null },
    'node-future-proofing': { title: 'Future-Proofing', type: 'Concept', description: 'Information should outlast the systems that created it.', link: null },
    'node-global-authorship': { title: 'Global Authorship', type: 'Concept', description: 'Everyone should be able to write to the web.', link: null },
    ...
    'node-manoff': { title: 'Manoff', type: 'Researcher', description: 'Archives are not neutral. There is no political power without control of the archive, if not memory.', link: null },
    ...
    'node-data-extraction': { title: 'Data Extraction', type: 'Concept', description: 'The business model of the internet. Every click, scroll, pause is harvested, packaged, sold.', link: null },
    'node-algorithmic-profiling': { title: 'Algorithmic Profiling', type: 'Concept', description: 'The version of you built from data.', link: null },
    'node-platform-governance': { title: 'Platform Governance', type: 'Concept', description: 'Content moderation, bans, API access.', link: null },
    'node-tracking': { title: 'Tracking', type: 'Concept', description: 'Cookies, pixels, fingerprints. Invisible infrastructure that follows you across the web.', link: null },
