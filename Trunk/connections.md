...
(function() {
  ...
  const previewData = {
    'node-millennial-epoch': { title: 'The Millennial Epoch', type: '', description: '', link: '/Trunk/epoch/' },
    'node-double-perspective': { title: 'Double Perspective', type: '', description: '', link: '/Trunk/dp/' },
    'node-experience-self': { title: 'Experience Self', type: '', description: '', link: null },
    'node-narrator-self': { title: 'Narrator Self', type: '', description: '', link: null },
    'node-tension': { title: 'Tension', type: '', description: '', link: null },
    'node-archive-codetermination': { title: 'Archive Codetermination', type: '', description: '', link: null },
    'node-memory': { title: 'Memory', type: '', description: '', link: null },
    'node-personal-memory': { title: 'Personal Memory', type: '', description: '', link: null },
    'node-collective-memory': { title: 'Collective Memory', type: '', description: '', link: null },
    'node-distorted-memory': { title: 'Distorted Memory', type: '', description: '', link: null },
    'node-familial-memory': { title: 'Familial Memory', type: '', description: '', link: null },
    'node-witness-memory': { title: 'Witness', type: '', description: '', link: null },
    'node-the-archive': { title: 'The Archive', type: '', description: '', link: '/Trunk/archive/' },
    'node-traditional-archive': { title: 'Traditional Archive', type: '', description: '', link: null },
    'node-digital-archive': { title: 'Digital Archive', type: '', description: '', link: null },
    'node-social-archive-concept': { title: 'Social Archive', type: '', description: '', link: '/Trunk/archive/' },
    'node-archive-fever': { title: 'Archive Fever', type: '', description: '', link: null },
    'node-the-drivers': { title: 'The Drivers', type: '', description: '', link: '/Trunk/drivers/' },
    'node-driver-place': { title: 'Place', type: '', description: '', link: '/Trunk/drivers/#place' },
    'node-driver-loss': { title: 'Loss', type: '', description: '', link: '/Trunk/drivers/#loss' },
    'node-driver-intimacy': { title: 'Intimacy', type: '', description: '', link: '/Trunk/drivers/#intimacy' },
    'node-driver-web': { title: 'Web', type: '', description: '', link: '/Trunk/drivers/#web' },
    'node-driver-identity': { title: 'Identity', type: '', description: '', link: '/Trunk/drivers/#identity' },
    'node-driver-expression': { title: 'Expression', type: '', description: '', link: '/Trunk/drivers/#expression' },
    'node-driver-future': { title: 'Future', type: '', description: '', link: '/Trunk/drivers/#future' },
    'node-driver-care': { title: 'Care', type: '', description: '', link: '/Trunk/drivers/#care' },
    'node-driver-witness': { title: 'Witness', type: '', description: '', link: '/Trunk/drivers/#witness' },
    'node-driver-surveillance': { title: 'Surveillance', type: '', description: '', link: '/Trunk/drivers/#surveillance' },
    'node-driver-emergence': { title: 'Emergence', type: '', description: '', link: '/Trunk/drivers/#emergence' },
    'node-driver-threshold': { title: 'Threshold', type: '', description: '', link: '/Trunk/drivers/#threshold' },
    'node-memory-technologies': { title: 'Memory Technologies', type: '', description: '', link: null },
    'node-email': { title: 'Email', type: '', description: '', link: null },
    'node-forums': { title: 'Forums', type: '', description: '', link: null },
    'node-myspace': { title: 'MySpace', type: '', description: '', link: null },
    'node-facebook': { title: 'Facebook', type: '', description: '', link: null },
    'node-twitter': { title: 'Twitter / X', type: '', description: '', link: null },
    'node-instagram': { title: 'Instagram', type: '', description: '', link: null },
    'node-tiktok': { title: 'TikTok', type: '', description: '', link: null },
    'node-smartphones': { title: 'Smartphones', type: '', description: '', link: null },
    'node-search-engines': { title: 'Search Engines', type: '', description: '', link: null },
    'node-ai': { title: 'AI', type: '', description: '', link: null },
    'node-berners-lee-web': { title: "Berners-Lee's Web", type: '', description: '', link: null },
    'node-hypertext': { title: 'Hypertext', type: '', description: '', link: null },
    'node-hypermedia': { title: 'Hypermedia', type: '', description: '', link: null },
    'node-universal-access': { title: 'Universal Access', type: '', description: '', link: null },
    'node-future-proofing': { title: 'Future-Proofing', type: '', description: '', link: null },
    'node-global-authorship': { title: 'Global Authorship', type: '', description: '', link: null },
    'node-digital-archival-theory': { title: 'Digital Archival Theory', type: '', description: '', link: '/Trunk/notes/' },
    'node-derrida': { title: 'Derrida', type: '', description: '', link: null },
    'node-manoff': { title: 'Manoff', type: '', description: '', link: null },
    'node-ismail': { title: 'Ismail', type: '', description: '', link: null },
    'node-contemporary-archive-studies': { title: 'Contemporary Studies', type: '', description: '', link: null },
    'node-surveillance': { title: 'Surveillance', type: '', description: '', link: null },
    'node-snowden': { title: 'Snowden', type: '', description: '', link: null },
    'node-data-extraction': { title: 'Data Extraction', type: '', description: '', link: null },
    'node-algorithmic-profiling': { title: 'Algorithmic Profiling', type: '', description: '', link: null },
    'node-platform-governance': { title: 'Platform Governance', type: '', description: '', link: null },
    'node-tracking': { title: 'Tracking', type: '', description: '', link: null },
    'node-digital-sobriety': { title: 'Digital Sobriety', type: '', description: '', link: null },
    'node-born-digital-objects': { title: 'Born-Digital Objects', type: '', description: '', link: null },
    'node-memes': { title: 'Memes', type: '', description: '', link: null },
    'node-screenshots': { title: 'Screenshots', type: '', description: '', link: null },
    'node-status-updates': { title: 'Status Updates', type: '', description: '', link: null },
    'node-stories': { title: 'Stories', type: '', description: '', link: null },
    'node-videos': { title: 'Videos', type: '', description: '', link: null },
    'node-photo-dumps': { title: 'Photo Dumps', type: '', description: '', link: null },
    'node-comments': { title: 'Comments', type: '', description: '', link: null },
    'node-memory-workers': { title: 'Memory Workers', type: '', description: '', link: '/Trunk/drivers/' },
    'node-archivists': { title: 'Archivists', type: '', description: '', link: null },
    'node-researchers': { title: 'Researchers', type: '', description: '', link: null },
    'node-writers': { title: 'Writers', type: '', description: '', link: '/Drivers/' },
    'node-poets': { title: 'Poets', type: '', description: '', link: '/Drivers/' },
    'node-families': { title: 'Families', type: '', description: '', link: null },
    'node-everyday-users': { title: 'Everyday Users', type: '', description: '', link: null },
    'node-cultural-systems': { title: 'Cultural Systems', type: '', description: '', link: null },
    'node-going-viral': { title: 'Going Viral', type: '', description: '', link: '/Trunk/archive/' },
    'node-parasocial': { title: 'Parasocial', type: '', description: '', link: '/Trunk/archive/' },
    'node-upgrade-you': { title: 'Upgrade You', type: '', description: '', link: '/Trunk/archive/' },
    'node-between-you-and-i': { title: 'Between You & I', type: '', description: '', link: '/Trunk/archive/' },
    'node-major-tensions': { title: 'Major Tensions', type: '', description: '', link: null },
    'node-central-thesis': { title: 'Central Thesis', type: '', description: '', link: null }
  };
...
<div class="driver-nav">
  <a href="/Trunk/new-developments/">← View artifacts</a>
