...
Here you will find some of the foundational ideas and research that went into creating this archive. The bullet list presentation is intentional. At the bottom of the page is a link to my Zotero bibliography where you can find full source information and my reading notes.
...
I built this framework using Vivian Gornick's *The Situation and the Story* and Phillip Lopate's *To Show and To Tell*. You can explore the interactive version of this framework on the <a href="/Trunk/dp/">Double Perspective</a> page.
...
* Generative AI as a new form of memory production
* Literary community response — submission guidelines as archival artifacts
* Who trains the models? Who owns the output?
* The difference between human recollection and machine generation
* <a href="/Trunk/new-developments/">AI Reception →</a>
