...
What happens when personal memory, cultural history, and digital platforms become the same thing?
  ...
  <!-- 5. CONNECTIONS -->
  <a href="/Trunk/connections/" class="trunk-card trunk-card-full" style="text-decoration: none;">
    <h3>Collection 05</h3>
    <h2>Connections</h2>
  ...
  <a href="/About/" class="trunk-card trunk-card-full" style="text-decoration: none;">
    ...
    <p>Click here for more information or Go straight to the form with the purple link below.</p>
    <p><span style="color: var(--pink);">Vroom Vroom →</span></p>
  </a>
</div>
<center>
<a href="/submit/" style="color: var(--purple);">Fill my gas tank →</a><br><br>
